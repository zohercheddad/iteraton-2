...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Monster[] monsters = new Monster[]{
                new Monster(200,400), new Monster(250,400), new Monster(300,400), new Monster(900,800)
        };
        ...
        scene.setOnKeyPressed(e -> {
            ...
            if (e.getCode() == KeyCode.S || e.getCode() == KeyCode.DOWN) { dy += joueur.getVitesse(); rotation = 180; }
            if (e.getCode() == KeyCode.Q || e.getCode() == KeyCode.LEFT) { dx -= joueur.getVitesse(); rotation = 270; }
            if (e.getCode() == KeyCode.D || e.getCode() == KeyCode.RIGHT) { dx += joueur.getVitesse(); rotation = 90; }
